...
int main(void) {
  ...
  should_be_exactly_equal("value_in_range(-1,100,514)", true,
		  	  value_in_range(-1,100,514));
  ...
  should_be_exactly_equal("sum_of_greater_squares(-4,-5,-6)", 61,
		  	  sum_of_greater_squares(-4,-5,-6));
  return 0;
}
